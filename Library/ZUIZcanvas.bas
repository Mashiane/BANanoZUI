...
#DesignerProperty: Key: Views, DisplayName: Views, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: VCloak, DisplayName: VCloak, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: VOnce, DisplayName: VOnce, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: VPre, DisplayName: VPre, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mVCloak As Boolean = False
...
Private mVOnce As Boolean = False
Private mVPre As Boolean = False
...
mVOnce = Props.Get("VOnce")
mVPre = Props.Get("VPre")
...
public Sub setVCloak(varVCloak As Boolean)
AddAttr("v-cloak", varVCloak)
mVCloak = varVCloak
End Sub

public Sub getVCloak() As Boolean
Return mVCloak
End Sub
...
public Sub setVOnce(varVOnce As Boolean)
AddAttr("v-once", varVOnce)
mVOnce = varVOnce
End Sub

public Sub getVOnce() As Boolean
Return mVOnce
End Sub

public Sub setVPre(varVPre As Boolean)
AddAttr("v-pre", varVPre)
mVPre = varVPre
End Sub

public Sub getVPre() As Boolean
Return mVPre
End Sub
